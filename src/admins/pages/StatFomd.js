...
const StatFomd = () => {
    ...
    const Mois = queryParamss.get('Mois');
    const M = queryParamss.get('ou');
    ...
    useEffect(() => {
        ...
        axios.get("/StatFomd?annee="+Annee+"&mois="+Mois)
            .then((response) => {
...
<div className="flex items-center justify-start h-full mb-6 ml-16">
                <div className="bg-white rounded-lg shadow-lg p-6 flex items-center space-x-4">
                    ...
                    <div>
                        <h1 className="text-xl font-bold">Formation période de:</h1>
                        <p className="text-gray-600 font-bold">{M} {Annee} </p>
                    </div>
                </div>
            </div>
                            ...
                            <table className="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
                                ...
                                {demandes.map(demande => (
                                    <tr className="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                                        <td className="px-4 py-3">{demande.categorie}</td>
