    ...
    <div className="flex flex-col items-center justify-center h-screen bg-gray-200">
      <div className="flex flex-wrap justify-center">
        <div className="flex flex-row space-x-4 w-1/3 mr-4">
          <div className="p-4 border rounded-lg border-blue-500 flex flex-col justify-center items-center 
          cursor-pointer transition duration-300 hover:border-blue-500 hover:bg-blue-600">
        ...
        <div className="flex flex-row space-x-4 w-1/3">
          ...
          cursor-pointer transition duration-300 hover:border-green-500 hover:bg-green-500">
            <div className="p-4 flex flex-col items-center">
              <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" className="w-24 h-24 rounded-full mb-4">
