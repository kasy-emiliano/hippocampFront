...
import { Layout, LandingPage, SignIn, 
        SignUp, ProfilForm, AdhesionForm,
        PasswordReset, ForgetPassword, InfoFormateur, 
        SignUpForm, SignInForm, Dashboard, 
        PasswordResetForm, ForgetPasswordForm, DashboardForm, 
        ModifApprenant, ModifPassword, ModifFormateur,
        ModifPasswordForm, Categorie, 
        Accueil, AjoutCat, Formations,
        DetailFormation, Userprofil, Resumer, 
        Modalform, Dashboardapprenant, Chapitre, 
        Zoom, Quiz, DashboardFormateur, 
        NewFormation, FormationList, Detailform, 
        Profilformateur, Video, Videochoice, 
        AddLesson, SignupChoice, AddQuiz, 
        Navlink, AddReponseQuiz, AddQuizOld2, 
        CarnotCode, ValidFormation, ListFormateur, 
        DetailFormAdmin, ChapitreAdmin, LessonAdmin, 
        ZoomAdmin, QuizAdmin, ListQuiz, 
        CoursApprenant, RechercheCours, ListCoursApprenant, 
        ChapitreApprenant, ZoomApprenant, QuizApprenant, 
        SuivreCours, ApprenantList, LessonApprenant, 
        ListQuizApprenant, NavExemple, ListZoomApprenant, 
        DetailQuizApprenant, DetailZoom, VoirListForm, 
        ListApprenant, DetailFormateur, MesCoursApprenant, 
        ListFormation, ModifierPhoto, SigninAdmin,
        ZoomForm,ReponseCommentaireForm,ListeFormationAcceuil,
        AjoutPublicite,StatA,StatAm,StatAmd,StatFom,StatFomd
        ,StatF,StatFm,StatFmd,StatFo,DetailFormationAccueil,
