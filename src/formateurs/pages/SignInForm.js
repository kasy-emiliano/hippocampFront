...
const SignInForm = () => {
    ...
    try {
      const response = await axios.post("/LoginFormateur?email="+email+"&password="+password);
       ...
       if(response.status === 200) {
        ...
        window.location.href="/dashboardformateur";
  ...
  <div class="flex flex-col items-center justify-center px-6 py-8 mx-auto md:h-screen lg:py-0">
          ...
          dark:text-white w-40 h-40 mr-2" src={images} alt="logo"/>  
          ...
          <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
              ...
              <form class="space-y-4 md:space-y-6"  onSubmit={handleSubmit}>
                  ...
                  <div class="flex items-center justify-between">
                      ...
                      <Link to="/forgetpasswordform" class="text-sm font-medium text-blue-700 hover:underline 
                      dark:text-primary-500">Mot de passe oublié ?
                      </Link>
                  </div>
                  <button type="submit" class="w-full text-white bg-blue-700 hover:bg-primary-700 focus:ring-4 focus:outline-none 
                  ...
                  <p class="text-sm font-light text-gray-500 dark:text-gray-400">
                   ...
                   <Link to="/adhesionform" class="font-medium text-blue-700  hover:underline dark:text-primary-500"> S'inscrire
                   </Link>
                  </p>
              </form>
          </div>
