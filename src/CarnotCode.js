...
const CarnotCode = () => {
  ...
  const handleSubmit = async () => {
    ...
    try {
          ...
          Swal.fire("Succès", "Les données ont été envoyées avec succès", "success");
          window.location.href="/carnotcode?idQuiz="+ idQuiz;
       } catch (error) {

        console.error('Erreur lors de l\'envoi des données au backend :', error);
        Swal.fire("Erreur", "Une erreur s'est produite lors de l'envoi des données", "error");
        //navigate("/carnotcode")
        window.location.href="/carnotcode";
